To add the bookmarklet to your browser, please manually add a bookmark with an arbitrary title (preferably "TOCit!") and with the following code as the link address (URL):
